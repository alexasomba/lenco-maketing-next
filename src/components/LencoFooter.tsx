      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-2 md:grid-cols-5 gap-x-12 gap-y-10 pb-12">
          ...
          <div className="col-span-2 md:col-span-1">
            ...
            {/* Country Selector */}
            <button className="flex items-center gap-2 px-3 py-2 border border-border rounded-md text-sm text-foreground mb-6 hover:border-primary/50 transition-colors">
            ...
            <a
              href="#get-started"
              className="inline-flex items-center justify-center px-6 py-3 bg-primary hover:bg-primary/90 rounded-lg text-sm text-primary-foreground font-medium transition-all whitespace-nowrap"
            >
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li>
                <a href="#current-account" className="text-muted-foreground hover:text-foreground text-sm transition-colors">
                  Business Current Account
                </a>
              </li>
              <li>
                <a href="#expense" className="text-muted-foreground hover:text-foreground text-sm transition-colors">
                  Expense Management
                </a>
              </li>
              <li>
                <a href="#payout" className="text-muted-foreground hover:text-foreground text-sm transition-colors">
                  Payout
                </a>
              </li>
              <li>
                <a href="#bill-payment" className="text-muted-foreground hover:text-foreground text-sm transition-colors">
                  Bill Payment
                </a>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li>
                <a href="#retail" className="text-muted-foreground hover:text-foreground text-sm transition-colors">
                  Retail
                </a>
              </li>
              <li>
                <a href="#startup" className="text-muted-foreground hover:text-foreground text-sm transition-colors">
                  Startup
                </a>
              </li>
              <li>
                <a href="#logistics" className="text-muted-foreground hover:text-foreground text-sm transition-colors">
                  Logistics
                </a>
              </li>
              <li>
                <a href="#developer" className="text-muted-foreground hover:text-foreground text-sm transition-colors">
                  Developer
                </a>
              </li>
              <li>
                <a href="#hospitality" className="text-muted-foreground hover:text-foreground text-sm transition-colors">
                  Hospitality
                </a>
              </li>
            </ul>
